...
class Polygon():
    def __init__(self, pos, length, height, space, mass=5.0): # atributes of polygon
        ...
        body.position = Vec2d(pos) # shape and size.
        shape = pm.Poly.create_box(body, (length, height)) # creat_box function
        shape.color = (0, 0, 255) # BLUE color
        shape.friction = 0.5
